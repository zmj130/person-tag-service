...
export const api = {
  ...
  deleteRule: id => request(`/api/tags/rules/${id}`, { method: 'DELETE' }),
  ...
  restorePerson: id => request(`/api/persons/${id}/restore`, { method: 'POST' }),
  personTags: id => request(`/api/persons/${id}/tags`),
  personIndicators: id => request(`/api/persons/${id}/indicators`),
  ...
  deleteRuleSet: id => request(`/api/rule-sets/${id}`, { method: 'DELETE' }),
